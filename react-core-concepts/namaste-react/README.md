...
| :--- | :--- | :--- | :--- |
| **01** | **Inception** | Core React fundamentals, library vs framework, rendering DOM nodes with HTML, JS, and React. | [View Episode 01](./01-inception/README.md) |
| **02** | **Igniting Our App** | Production readiness, NPM, Parcel bundler, HMR, `.parcel-cache`, `/dist`, and Browserslist. | [View Episode 02](./02-igniting-our-app/README.md) |
| **03** | **Laying the Foundation** | NPM build scripts, JSX syntax, Babel transpilation, functional components, and component composition. | [View Episode 03](./03-laying-the-foundation/README.md) |
...
### 🚀 [Episode 01: Inception](./01-inception/README.md)
...
### 🔥 [Episode 02: Igniting Our App](./02-igniting-our-app/README.md)
...
### 🏗️ [Episode 03: Laying the Foundation](./03-laying-the-foundation/README.md)
- **Topics Learned**: Custom NPM scripts (`start`, `build`), JSX introduction, Babel transpilation flow (`JSX` → `React.createElement` → `ReactElement` → `DOM`), HTML vs JSX syntax, Class vs Functional Components, Component Composition, `{}` JS expression evaluation, XSS data sanitization.
...
### 🍕 [Episode 04: Talk is Cheap, Show me the Code!](./04-talk-is-cheap-show-me-the-code/README.md)
...
### 🎣 [Episode 05: Let's Get Hooked!](./05-lets-get-hooked/README.md)
